  ...
  return (
    <div className="relative min-h-screen max-w-7xl mx-auto p-4 md:p-10 animate-in fade-in duration-700">
      ...
      <header className="flex flex-col md:flex-row md:items-center justify-between gap-8 mb-12">
        ...
        {/* Floating Navigation */}
        <nav className="flex items-center gap-3 bg-[#f8fafc] p-2 rounded-[28px] border border-slate-100 shadow-inner overflow-x-auto no-scrollbar">
          {tabs.map((tab) => {
            ...
            return (
              <Link
                ...
                href={tab.href}
                className={`
                  flex items-center gap-3 px-6 py-3 rounded-[22px] text-sm font-bold transition-all duration-300 whitespace-nowrap
                  ${isActive 
      ...
      {/* --- CONTENT AREA (Double Divs & Decorative line removed) --- */}
